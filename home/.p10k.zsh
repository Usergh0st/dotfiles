# Generated by Powerlevel10k configuration wizard on 2026-08-20 at 09:03 AST.
...
() {
  ...
  typeset -g POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=(
    ...
    status                  # status of things
    yazi                    # yazi file manager
    command_execution_time  # execution time of commands
  ...
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(
    ...
    # virtualenv             # python virtual environment (https://docs.python.org/3/)
    ...
    # package                # name@version from package.json (https://docs.npmjs.com/)
    ...
    # aws                    # aws profile (https://docs.aws.amazon.com/)
    # aws_eb_env             # aws elastic beanstalk environment (https://aws.amazon.com/)
    # azure                  # azure account name (https://docs.microsoft.com/en-us/cli/azure)
    # gcloud                 # google cloud cli account and project (https://cloud.google.com/)
    # google_app_cred        # google application credentials (https://cloud.google.com/)
    ...
    # nix_shell              # nix shell (https://nixos.org/nixos/nix-pills/)
